    ...
    <section id="home" className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-navy-50 px-6">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute inset-0 overflow-hidden opacity-[0.03]">
          ...
          <div className="absolute top-[45%] left-[5%] text-4xl md:text-6xl font-black text-navy-900 rotate-[-20deg] select-none">Web</div>
          <div className="absolute top-[70%] right-[10%] text-5xl md:text-7xl font-black text-crimson-600 rotate-[15deg] select-none">AI</div>
          <div className="absolute bottom-[15%] left-[15%] text-3xl md:text-5xl font-black text-navy-900 rotate-[-25deg] select-none">Automation</div>
